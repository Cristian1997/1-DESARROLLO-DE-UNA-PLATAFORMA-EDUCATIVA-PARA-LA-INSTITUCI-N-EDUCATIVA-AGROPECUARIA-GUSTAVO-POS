...
<head>
    <title>Iniciar sesión || EducaNET</title>
    <meta charset="UTF-8">
        ...
        <div class="container-login100" style="background-image: url('images/bg-01.png');">
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                ...
                <div class="wrap-input100 validate-input" data-validate="Password is required">
                    ...
                    <input class="input100" type="password" name="pass" placeholder="Escriba la contraseña"
                        id="txt_con">
                    <span class="focus-input100" data-symbol="&#xf190;"></span>
                ...
                document.getElementById('togglePassword').addEventListener('click', function() {
                    var passwordField = document.getElementById('txt_con');
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header" style="text-aling:left;">
                    ...
                    <h4 class="modal-title"><b>Restablece contrase&ntilde;a</b></h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                    <div class="col-lg-12">
                        <label for=""><b>Ingrese el email registrado en el usuario para enviarle su contrase&ntilde;a
