...
$id_horario_docente = htmlspecialchars($_POST['id_horario_docente'], ENT_QUOTES, 'UTF-8');
...
$consulta = $MH->Editar_Horario_Docente($id_horario_docente, $bloque_1, $bloque_2, $bloque_3, $bloque_4, $bloque_5, $bloque_6,
