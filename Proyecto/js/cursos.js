...
/* FUNSION ACTIVAR CURSOS REGISTRADOS*/
...
/* FUNSION DESASTIVAR CURSOS REGISTRADOS*/
...
function Modificar_Estatus(ID, estatus) {
    ...
    $.ajax({
        ...
        if (resp > 0) {
            Swal.fire("Mensaje De Confirmacion", "La asignatura se " + mensaje + " con exito", "success")
                .then((value) => {
...
/* FUNSION EDITAR CURSOS REGISTRADOS*/
    ...
    $.ajax({
        ...
        if (resp > 0) {
            if (resp == 1) {
                ...
                Swal.fire("Mensaje De Confirmacion", "Datos correctamente, Nueva Asignatura Registrada", "success")
                    .then((value) => {
                        LimpiarRegistro();
                ...
                return Swal.fire("Mensaje De Advertencia", "Lo sentimos, la Asignatura ya existe en la base de datos", "warning");
            }
        } else {
