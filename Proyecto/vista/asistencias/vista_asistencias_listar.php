...
<form autocomplete="false" onsubmit="return false" id="modal1">
    <div class="modal fade" id="modal_editar" role="dialog">
                    ...
                    <div class="box box-solid">
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-lg-12">
                             ...
                             <select class="js-example-basic-single" id="cmb_asistencia" style="width: 100%;">
     ...
     <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="Editar_asistencias()"><i class="fa fa-edit" ><b>&nbsp;Editar!</b></i></button>
    </div>
</div>
</div>
</div>
