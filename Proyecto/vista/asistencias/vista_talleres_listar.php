...
<div class="col-md-12">
    ...
    <div class="col-lg-4" hidden>
        ...
        <select class="js-example-basic-single" name="state" id="cbm_asignatura" style="width:100%;"></select><br><br>
    </div>
    
    <div class="col-lg-4" hidden>
        <label for="">Mis Grupos</label>
        <select class="js-example-basic-single" name="state" id="cbm_grado" style="width:100%;"></select><br><br>
    </div>

    <div class="col-lg-6">
        <label for="">Mis Grupos</label>
        <select class="js-example-basic-single" name="state" id="cbm_grupo" style="width:100%;"></select><br><br>
    </div>
...
<div class="modal fade" id="modal_ver_asistencia_estudiante" role="dialog">
    ...
    <h4 id="grado_modal_title" class="modal-title"><i class="fa fa-check-square-o"></i><b>&nbsp; Asistencias del estudiante</b></h4>
</div>
