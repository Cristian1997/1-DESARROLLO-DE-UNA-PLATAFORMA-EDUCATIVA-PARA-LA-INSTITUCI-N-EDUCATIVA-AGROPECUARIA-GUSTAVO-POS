...
<style>
        ...
        .conversations-box {
            height: calc(96vh - 70px); /* Altura ajustada para ocupar el espacio vertical */
...
<div class="row">
    ...
    <div class="col-lg-5">
        <button class="btn btn-success btn-block" onclick="nuevo_chat_docentes()"><i class="fa fa-commenting-o"></i> Nuevo Chat</button>
    </div>
</div>
</div>
            <div class="box-header with-border">
