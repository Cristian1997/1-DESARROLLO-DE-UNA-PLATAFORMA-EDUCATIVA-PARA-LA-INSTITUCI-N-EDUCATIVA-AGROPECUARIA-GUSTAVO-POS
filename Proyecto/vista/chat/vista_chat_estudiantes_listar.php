            ...
            <div class="box box-success direct-chat direct-chat-success">
                ...
                <div class="box-body">
                    ...
                    <div class="col-lg-12">
                        ...
                        <br>
                        <textarea name="" id="txt_comentario" cols="1" rows="3" class="form-control" style="resize:none;"></textarea>
                        <br>
                    </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <br>
                                <input type="file" id="txt_archivo_subir">
                                <br>
                                <br>
                            </div>
                        </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <br>
                                <input type="file" id="txt_imagen_subir" onchange="previewImage()">
                                <br>
                                <br>
