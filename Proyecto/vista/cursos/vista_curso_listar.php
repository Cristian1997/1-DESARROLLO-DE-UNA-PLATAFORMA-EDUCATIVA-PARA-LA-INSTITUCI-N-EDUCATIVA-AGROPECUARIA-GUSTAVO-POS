        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <input type="text" class="form-control" id="txt_nombres"
                                placeholder="Ingrese nombres de Asignatura" maxlength="50"
                ...
                <div class="modal-footer">
                    <button class="btn btn-primary" onclick="Registrar_asignatura()"><i
    ...
    <div class="modal fade" id="modal_editar" role="dialog">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button class="btn btn-primary" onclick="Editar_Asignaturas()"><i
                            class="fa fa-check"><b>&nbsp;Editar Registro</b></i></button>
                    <button type="button" class="btn btn-danger" data-dismiss="modal"><i
                            class="fa fa-close"><b>&nbsp;Cerrar</b></i></button>
                </div>
            </div>
