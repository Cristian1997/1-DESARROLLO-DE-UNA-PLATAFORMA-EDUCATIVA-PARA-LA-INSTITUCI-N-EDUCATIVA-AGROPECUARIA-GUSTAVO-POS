        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button class="btn btn-primary" onclick="Registrar_Docente()"><i
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <label for="">Documento</label>
                            <input type="text" id="txt_documento_editar_actual" hidden><input type="text"
                                class="form-control" id="txt_documento_editar_nuevo" placeholder="Ingrese documento"
                                onkeypress="return soloNumeros(event)"><br>
                        </div>
                        <div class="col-lg-6">
                            <label for="">Telefono</label>
                ...
                <div class="modal-footer">
                    <button class="btn btn-primary" onclick="Editar_Docente()"><i class="fa fa-check"><b>&nbsp;Editar
                                Registro</b></i></button>
                    <button type="button" class="btn btn-danger" data-dismiss="modal"><i
                            class="fa fa-close"><b>&nbsp;Cerrar</b></i></button>
                </div>
