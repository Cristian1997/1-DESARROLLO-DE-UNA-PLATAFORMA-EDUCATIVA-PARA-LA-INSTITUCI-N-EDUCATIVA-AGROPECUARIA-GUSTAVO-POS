            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row"> 
                          <div class="col-lg-12">
                            <label for="">Documento</label>
                            <input type="text" id="txt_documento_editar_actual" ><input type="text" class="form-control" id="txt_documento_editar_nuevo" placeholder="Ingrese documento"onkeypress="return soloNumeros(event)"><br>
                        </div>
                        <div class="col-lg-6">
