    ...
    <div class="box box-warning box-solid">
        ...
        <div class="box-body">
            <div class="form-group">
                ...
                <div class="col-lg-6">
                    <label for="">Mis Grupos</label>
                    <select class="js-example-basic-single1" name="state" id="cbm_grupo"
                ...
                <div class="col-lg-3">
                    ...
                    <button class="btn btn-danger" style="width:100%" onclick="AbrirModalRegistro()"><i
                            class="glyphicon glyphicon-plus"></i>&nbsp; Registrar Foro</button>
                </div>
                <br><br><br>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <textarea name="" id="descripcion_foro" cols="20" rows="5" class="form-control"
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" onclick="registrar_foro()"><i
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <label for="">&nbsp; Mis Grupos</label>
                            <select class="js-example-basic-single1" name="state" id="cbm_grupo_editar"
                                style="width:100%;">
                        ...
                        <div class="col-lg-12">
                            ...
                            <label for="">&nbsp;Descripci&oacute;n</label><br>
                            <textarea name="" id="descripcion_foro_editar" cols="20" rows="8" class="form-control"
                                style="resize:none;"></textarea>
                        </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" onclick="editar_foro()"><i
    ...
    <div class="modal fade" id="modal_fecha" role="dialog">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" onclick="editar_fecha()"><i
                            class="fa fa-check"><b>&nbsp;Editar Fecha</b></i></button>
                    <button type="button" class="btn btn-danger" data-dismiss="modal"><i
                            class="fa fa-close"><b>&nbsp;Cerrar</b></i></button>
                </div>
            </div>
