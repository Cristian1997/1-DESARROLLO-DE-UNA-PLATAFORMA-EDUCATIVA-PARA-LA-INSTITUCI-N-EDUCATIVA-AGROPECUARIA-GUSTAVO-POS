    ...
    <div class="box box-warning box-solid">
        ...
        <div class="box-body">
            <div class="form-group">
                ...
                <div class="col-lg-9">
                    <label for="">Mis Grupos</label>
                    <select class="js-example-basic-single1" name="state" id="cbm_gruposs" style="width:100%;"></select>
                    <br>
                    <br>
                </div>
        ...
        <div class="box box-warning">
            ...
            <div class="box-body">
                ...
                <div id="comentario_foro_area">
                    ...
                    <textarea name="" id="txt_comentario" cols="10" rows="5" class="form-control" style="resize:none;"></textarea>
                    <br>
                ...
                <div class="modal-body">
                    <div class="box box-warning">
                        ...
                        <div id="comentario_foro_area_respuesta">
                            ...
                            <textarea name="" id="txt_comentario_respuesta" cols="10" rows="5" class="form-control" style="resize:none;"></textarea>
                            <br>
                            <div class="input-group-btn">
