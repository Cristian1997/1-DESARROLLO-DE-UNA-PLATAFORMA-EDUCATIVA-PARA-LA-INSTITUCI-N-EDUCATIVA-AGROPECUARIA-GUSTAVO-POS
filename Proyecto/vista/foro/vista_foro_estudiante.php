...
@media only screen and (max-width: 768px) {
    ...
    /* Estilos para el botón de acción específico */
    #tabla_foro .ver_foro.btn {
        visibility: visible !important;
        position: static !important;
    }

    /* Ajuste adicional para el botón de acción */
    #tabla_foro .ver_foro.btn i {
        display: inline !important;
    }

    /* Ocultar el botón de desocultar */
    #tabla_foro_wrapper .dataTables_scrollHead .dataTable {
        overflow-x: auto;
    }

    /* Ajuste para el ancho de la tabla cuando aparece el botón de desocultar */
    #tabla_foro_wrapper .dataTables_scrollHeadInner {
        width: auto !important;
    }

    /* Ocultar el botón "+" en la primera columna */
    #tabla_foro td:first-child::before {
...
<div class="col-md-12">
    <div class="box box-warning box-solid">
        ...
        <div class="box-body">
            <div class="form-group">
                ...
                <div class="col-lg-9">
                    <label for="">Mis Grupos</label>
                    <select class="js-example-basic-single1" name="state" id="cbm_gruposs"
                        style="width:100%;"></select><br><br>
                </div>
                <div class="col-lg-3">
                    <label for="">&nbsp;</label><br>
                    <button class="btn btn-primary" style="width:100%" onclick="listar()"><i class="fa fa-search"></i>
                        Listar</button>
                </div>
    ...
    <input type="text" id="id_docente_verifity_est" hidden>
        ...
        <div class="box box-warning">
            ...
            <div class="box-body">
                ...
                <div id="comentario_foro_area">
                    ...
                    <textarea name="" id="txt_comentario" cols="10" rows="5" class="form-control"
                        style="resize:none;"></textarea><br>


                    <div class="input-group-btn">
                        <button type="button" class="btn btn-success" id="btnregistar"
                            onclick="registrar_comentario_foro()">Agregar Comentario <i class="fa fa-plus"></i></button>
                    </div>

                    <button type="button" class="btn btn-success" id="btnEditar"
                        onclick="editar_comentario_foro()">Editar comentario <i class="fa fa-pencil"></i></button>
                    <button type="button" class="btn btn-danger cancelar_editar_comentario_foro"
                        id="btnCancelarEditar"><i class="fa fa-close"><b>&nbsp;Cancelar</b></i></button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="box box-warning">
                        <div class="box-header with-border">
                            <div class="user-block">
                                <img id="img_modal" class="img-circle" src="../dist/img/user1-128x128.jpg"
                                    alt="User Image">
                        ...
                        <div class="box-header with-border">
                            ...
                            <button type="button" class="responder_modal btn btn-default btn-xs pull-left"
                                data-id-responde_a="" id="btnResponderModal">
                                <i class="fa fa-comments"></i> Responder
                            </button>
                        </div>

                        <div class="box-body">
                            <span class="pull-right text-muted">Respuestas: <span
                                    id="txt_contador_respuestas"></span></span>
                            <br><br>
                        ...
                        <div id="comentario_foro_area_respuesta">
                            ...
                            <center>
                                <h4><span class="title">Responder a ---> <span id="lbl_responder_a">_____</span></span>
                                </h4>
                            </center>

                            <textarea name="" id="txt_comentario_respuesta" cols="10" rows="5" class="form-control"
                                style="resize:none;"></textarea><br>
                            <div class="input-group-btn">
                                <button type="button" class="btn btn-success" id="btnregistarrespuesta"
                                    onclick="registrar_comentario_foro_respuesta()">Agregar respuesta <i
                                        class="fa fa-plus"></i></button>


                                <button type="button" class="btn btn-success" id="btnEditarrespuesta"
                                    onclick="editar_comentario_foro_respuesta()">Editar respuesta <i
                                        class="fa fa-pencil"></i></button>
                                <button type="button" class="btn btn-danger cancelar_responder_comentario_foro"
                                    id="btnCancelarResponder" style="margin-left: 5px;"><i
