            ...
            $('form[name="inscripcion"]').submit(function (e) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        // Redirige a la nueva URL después de que la operación del servidor haya finalizado
                        window.location.href = '/proyect/vista/horarios/remplazar/horarios_admin.php';
                    }
                });
            });
        });
