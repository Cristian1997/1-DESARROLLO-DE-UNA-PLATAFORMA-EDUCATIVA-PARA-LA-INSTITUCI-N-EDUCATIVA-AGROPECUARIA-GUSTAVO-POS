        ...
        <div class="widget-user-header bg-green">
            ...
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <button class="nueva_carpeta  btn btn-primary custom-btn pull-right"
                        style="width: 100px; height: 23px; font-size: 12px; padding: 1px;">
            ...
            <div class="widget-user-image">
                <br>
                <img id="user-avatar" class="img-circle" src="../dist/img/user7-128x128.jpg" alt="User Avatar"
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" onclick="editar_carpeta_material()"><i
                        class="fa fa-check"><b>&nbsp;Editar carpeta</b></i></button>
