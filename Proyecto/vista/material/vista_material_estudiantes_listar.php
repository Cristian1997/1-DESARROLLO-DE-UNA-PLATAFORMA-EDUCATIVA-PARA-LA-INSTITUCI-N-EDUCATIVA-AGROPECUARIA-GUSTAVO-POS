        ...
        <div class="widget-user-header bg-green">
            ...
            <div class="box-header with-border">
                ...
                <div class="box-tools" style="display: flex;">
                    ...
                    <button id="btn_filtrar_material_docente" class="btn btn-primary" style="margin-left: 10px;" onclick="mostrarNuevaImagen()">Buscar material</button>
                </div>
            </div>

            <div class="widget-user-image" id="user-avatar-container" style="display: none;">
                <br>
                <img id="user-avatar" class="img-circle" src="../controlador/usuario/foto/docente20320249321.jpg" alt="Selecciona un DOC" title="Selecciona a un docente" style="width: 50px; height: 50px; border-radius: 50%;">
            </div>
...
<div class="container">
    <div class="row">
        <!-- Aquí está el div ocultar/mostrar -->
...
<div class="modal fade" id="modal_editar_carpeta" role="dialog">
    <div class="modal-dialog modal-xs">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" onclick="editar_carpeta_material()"><i class="fa fa-check"><b>&nbsp;Crear carpeta</b></i></button>
                <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fa fa-close"><b>&nbsp;Cerrar</b></i></button>
            </div>
        </div>
    </div>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <br>
                        <input type="file" id="txt_archivo_subir_editar">
                        <br>
                    </div>
