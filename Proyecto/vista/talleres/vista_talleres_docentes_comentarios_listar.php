                    ...
                    <div class="modal-body">
                        <div class="row ">
                            ...
                            <div class="col-lg-12">
                                ...
                                <br>
                                <textarea name="" id="txt_ver" cols="50" rows="10" class="form-control" style="resize:none;"></textarea>
                                <br>
                                <br>
                            </div>
                ...
                <div class="modal-content ">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-lg-12">
                            ...
                            <br>
                            <textarea name="" id="txt_ver_resp" cols="50" rows="10" class="form-control" style="resize:none;"></textarea>
                            <br>
                            <br>
                        </div>
