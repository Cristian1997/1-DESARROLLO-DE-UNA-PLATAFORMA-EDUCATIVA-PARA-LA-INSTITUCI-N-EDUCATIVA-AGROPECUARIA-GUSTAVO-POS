 ...
 <div class="small-box bg-aqua">
    ...
    <div class="box box-success direct-chat direct-chat-success">
                    ...
                    <li>
                        <a href="#">
                            ...
                            <div class="contacts-list-info">
                                <span class="contacts-list-name">nombre contacto <small class="contacts-list-date pull-right">fecha</small></span>
        ...
        <div class="col-lg-12">
            ...
            <br>
            <textarea name="" id="txt_comentario2" cols="1" rows="3" class="form-control" style="resize:none;"></textarea>
            <br>
            <br>
        </div>
                ...
                <div class="modal-body">
                    <div class="rows">
                        ...
                        <div class="col-lg-12">
                            <label for="">&nbsp;Comentario</label>
                            <br>
                            <textarea name="" id="txt_ver" cols="30" rows="10" class="form-control" style="resize:none;"></textarea>
                            <br>
                            <br>
                        </div>
                ...
                <div class="modal-body">
                    <div class="rows">
                        ...
                        <div class="col-lg-12">
                            ...
                            <br>
                            <textarea name="" id="txt_resp" cols="50" rows="10" class="form-control" style="resize:none;"></textarea>
                            <br>
                            <br>
                        </div>
