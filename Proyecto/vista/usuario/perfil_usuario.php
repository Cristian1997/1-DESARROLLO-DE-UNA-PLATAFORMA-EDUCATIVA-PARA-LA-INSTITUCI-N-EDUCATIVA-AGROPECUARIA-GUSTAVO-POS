                                    ...
                                    <div class="col-lg-12">
                                            ...
                                            <div class="perfil-usuario-header">
                                              <div class="perfil-usuario-portada">
                                                ...
                                                <div class="perfil-usuario-avatar" >
                                                 ...
                                                 alt="User profile picture" id="img_perfil" style="width: 165px; height: 165px; ">   
                                      ...
                                      <ul class="list-group list-group-unbordered mb-3">
                                        <li class="list-group-item">
                                          <b>&nbsp;&nbsp;<i class="fa fa-user"></i>&nbsp;Usuario</b> <a class="float-right"><?php echo $_SESSION['S_USER']; ?></a>
                                        </li>
                                        <li class="list-group-item">
                                          <b>&nbsp;&nbsp;<i class="fa fa-credit-card"></i>&nbsp;Nombre</b>&nbsp; <a class="float-right"><label  id="lbl_nombre"></label></a>
                                        </li> 
                                        <li class="list-group-item">
    <b>&nbsp;&nbsp;<i id="icono_sexo" class="fa"></i>&nbsp;Sexo</b>&nbsp;
    <a class="float-right"><label id="sexo"></label></a>
</li>
                                        <li class="list-group-item">
                                          <b>&nbsp;<i class="fa fa-spinner"></i>&nbsp;Rol</b>&nbsp; <a class="float-right"><label  id="rol"></label></a>
                                        </li>
                                        <li class="list-group-item">
                                          <b>&nbsp;  <i class="fa fa-envelope"></i>&nbsp;Correo</b> &nbsp;<a href=""> <label  id="email"></label></a>
                                        </li>
