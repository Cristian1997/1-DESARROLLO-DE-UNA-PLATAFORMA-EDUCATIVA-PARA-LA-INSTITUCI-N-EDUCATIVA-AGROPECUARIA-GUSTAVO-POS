...
<body>
    <div class="thebody text-center">
        <div class="container align-items-center " style="margin-top: 1%;">
            <button id="start" class="btn btn-light btn-lg" type="button" onclick="iniciarNuevaVideoLlamada()"><b>Iniciar nueva video llamada</b></button>
            <button id="ingresarConEnlaceAnterior" class="btn btn-light btn-lg" type="button" onclick="ingresarConEnlaceAnterior()"><b>Ingresar con enlace anterior</b></button>
        </div>
    </div>
...
<!-- Agrega este HTML para el modal -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <input type="text" id="roomNameInput" class="form-control" placeholder="Ingrese el enlace de la sala">
      </div>
