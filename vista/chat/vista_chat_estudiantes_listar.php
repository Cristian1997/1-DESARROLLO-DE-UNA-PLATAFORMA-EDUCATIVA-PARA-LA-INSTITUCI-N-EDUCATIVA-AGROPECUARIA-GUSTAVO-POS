...
<style>
        ...
        .conversations-box {
            height: calc(93vh - 100px); /* Altura ajustada para ocupar el espacio vertical */
            overflow-y: auto; /* Agregar barra de desplazamiento vertical si el contenido es largo */
        ...
        .contacts-list-name {
    color: black !important; /* Cambia el color del texto a negro, anulando cualquier otro estilo */
...
<div class="row">
    ...
    <div class="col-lg-7">
    <div class="input-group">
        <input type="text" class="global_filter_nombre_conversaciones form-control" id="global_filter_nombre_conversaciones" placeholder="Buscar por nombre">
        <span class="input-group-addon"><i class="fa fa-search"></i></span>
    </div>
    </div>
    <div class="col-lg-5">
        <button class="btn btn-success btn-block" onclick="nuevo_chat_estudiantes()"><i class="fa fa-commenting-o"></i> Nuevo Chat</button>
    </div>
</div>
</div>
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    ...
                    <span class="label label-danger">Total Conversaciones: <span id="txt_contador_conversaciones"></span></span>
                </div>
            </div>
    ...
    <div class="box box-success direct-chat direct-chat-success">
        <div class="box-header with-border">
            ...
            <div class="box-tools pull-right" style="display: none;">
                ...
                <img id="message_user_image" class="direct-chat-img" src="../dist/img/user1-128x128.jpg" alt="Message User Image">
 ...
 <span id="mensaje_escribiendo" class="escribiendo" style="display: none;">Escribiendo...</span>
        ...
        <div class="col-md-6">
            ...
            <div class="btn-group">
    <button type="button" title="Elegir archivo!" class="btn btn-success fa fa-paperclip" id="archivo" data-toggle="dropdown">
        <span class="caret"></span>
    </button>
    <ul class="dropdown-menu">
        <li><a href="#" id="elegir_documento" class="fa fa-paperclip">  Elegir documento</a></li >
        <li><a href="#" id="elegir_imagen" class="fa fa-picture-o">  Elegir imagen</a></li>
    </ul>
</div>
        ...
        <button type="button" title="Desplazar chat hasta los últimos mensajes!" class="btn btn-success fa fa-long-arrow-down" id="scrollDownButton"></button>
        </div>
    </div><br>
                <textarea name="" id="txt_comentario" cols="1" rows="3" class="form-control" style="resize:none;"></textarea><br>
            </div>

            <div class="modal-footer">
    <div class="pull-left">
        <button type="button" class="btn btn-primary" onclick="responder_chat()"><i class="fa fa-commenting-o"></i>&nbsp;<b>Enviar Mensaje</b></button>
    </div>
</div>
...
<div class="modal fade" id="modal_nuevo_chat_estudiantes" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header" style="text-align:center">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title"><i class="fa fa-commenting-o"></i><b>&nbsp; Iniciar un chat nuevo</b></h4>
                    ...
                    <div class="col-md-12">
                        <div class="box box-danger">
                            <div class="box-header with-border">
                                ...
                                <div class="box-tools pull-right">
                                <span class="label label-danger">Total Integrantes: <span id="txt_contador_integrantes">0</span></span>
                                  
                                </div>
                            </div>
                            <div class="box-body no-padding">
                                <ul id="lista_estudiantes" class="users-list clearfix">
...
<div class="modal fade" id="modal_archivo_documento" role="dialog">
    <div class="modal-dialog modal-xs">
        <div class="modal-content">
            <div class="modal-header" style="text-align:center">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title"><i class="fa fa-commenting-o"></i><b>&nbsp; Elejir Archivo</b></h4>
            ...
            <div class="modal-body">
                ...
                <div class="col-lg-12"><br>
                   ...
                   <textarea name="" id="txt_mensaje_documento" cols="1" rows="6" class="form-control" style="resize:none;"></textarea>
               </div>
                <div class="col-lg-12"><br>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-12"><br>
                        <label for="">&nbsp;Mensaje</label><br>
                        <textarea name="" id="txt_mensaje_imagen" cols="1" rows="6" class="form-control" style="resize:none;"></textarea>
                    </div>
                    <div class="col-lg-12"><br>
                        <label for="">&nbsp;Subir imagen</label><br>
                        <input type="file" id="txt_imagen_subir" onchange="previewImage()"><br><br>
                        <img id="imagen_previa" src="#" alt="Vista previa de la imagen" style="max-width: 100%; max-height: 200px; display: none; margin: auto; display: block;">
                    </div>
                </div>
            </div>
            <div class="modal-footer">    
                <button type="button" class="btn btn-primary" onclick="enviar_imagen()"><i class="fa fa-check"><b>&nbsp;Enviar imagen</b></i></button>
                <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fa fa-close"><b>&nbsp;Cerrar</b></i></button>
            </div>
        </div>
    </div>
