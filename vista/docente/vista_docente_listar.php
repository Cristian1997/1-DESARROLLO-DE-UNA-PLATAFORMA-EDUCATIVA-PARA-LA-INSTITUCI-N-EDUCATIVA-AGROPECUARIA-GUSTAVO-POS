                ...
                <div class="modal-body">
                    <div class="row"> 
                        <div class="col-lg-6">
                            ...
                            <label for="">Nombres</label>
                            <input type="text" class="form-control" id="txt_nombres_editar" placeholder="Ingrese nombres" maxlength="50" onkeypress="return soloLetras(event)"><br>
                        </div>
                        <div class="col-lg-6">
                            <label for="">Apellidos</label>
                            <input type="text" class="form-control" id="txt_apellidos_editar" placeholder="Ingrese apellidos" maxlength="50" onkeypress="return soloLetras(event)"><br>
                        </div>
                        <div class="col-lg-6">
                            <label for="">Documento</label>
                            <input type="text" id="txt_documento_editar_actual" hidden><input type="text" class="form-control" id="txt_documento_editar_nuevo" placeholder="Ingrese documento"onkeypress="return soloNumeros(event)"><br>
                        </div>
                        <div class="col-lg-6">
                            <label for="">Telefono</label>
                            <input type="data" class="form-control" id="txt_telefono_editar" placeholder="Ingrese telefono"onkeypress="return soloNumeros(event)"><br>
